    ...
    <section className="relative w-full bg-[#f8fafc] py-5 sm:py-8 md:py-10 px-6 sm:px-10 md:px-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <motion.div
          ...
          className="relative w-full h-90 sm:h-115 md:h-150"
        >
          <div className="grid grid-cols-2 grid-rows-2 gap-2.5 sm:gap-3 w-full h-full">
            <div className="row-span-2 relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-sm">
              <Image
                src="/brand/lab1.png"
